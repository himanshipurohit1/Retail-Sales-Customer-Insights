...
4.	Created new calculated fields where necessary

Step 3: Exploratory Data Analysis (EDA)
1.	Analyzed sales trends
2.	Studied category and segment performance
3.	Identified seasonal patterns
4.	Evaluated shipping performance

Step 4: SQL Analysis (PostgreSQL)
1.	Loaded cleaned data into PostgreSQL
2.	Wrote SQL queries to analyze:
3.	Revenue by region
4.	Top products
5.	Customer segmentation
6.	Monthly sales trends
7.	Order performance metrics

Step 5: Power BI Dashboard
1.	Built interactive dashboard
2.	Created KPIs:
3.	Total Sales
4.	Number of Orders
5.	Average Order Value
6.	Repeat Rate
7.	Added visualizations for:
8.	Sales by category
9.	Sales by region
10.	Monthly trends
...
•	Technology category driving highest revenue
•	Consumer segment contributing largest sales share
•	Stable shipping performance (~4 days average)
•	The dashboard enables business stakeholders to monitor performance and make data-driven decisions.

Results & Insights
•	Identified key revenue-driving categories and segments
•	Detected seasonal sales trends
•	Evaluated customer retention through repeat rate
•	Analyzed operational efficiency via shipping metrics
